#ifndef _FRAME_URLREADER_H_
#define _FRAME_URLREADER_H_

#include "frame_base.h"
#include "../epdgui/epdgui.h"
#include "SD.h"

class Frame_urlReader : public Frame_Base
{
public:
    Frame_urlReader(String url);
    ~Frame_urlReader();
...
private:
    bool cacheFileSD(String url, String filename);
